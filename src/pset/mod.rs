        ...
        for psetin in self.inputs.into_iter() {
            let txin = TxIn {
                ...
                asset_issuance: AssetIssuance {
                    asset_blinding_nonce: psetin.issuance_blinding_nonce.unwrap_or([0u8; 32]),
                ...
                witness: TxInWitness {
                    amount_rangeproof: psetin.issuance_value_rangeproof.unwrap_or(Vec::new()),
                    inflation_keys_rangeproof: psetin.issuance_keys_rangeproof.unwrap_or(Vec::new()),
        ...
        for out in self.outputs {
            let txout = TxOut {
                ...
                nonce: out.blinding_key
                    .map(confidential::Nonce::from_pubkey)
                    .unwrap_or(confidential::Nonce::Null),
                script_pubkey: out.script_pubkey,
                witness: TxOutWitness {
                    surjection_proof: out.asset_surjection_proof.unwrap_or(Vec::new()),
                    rangeproof: out.value_rangeproof.unwrap_or(Vec::new()),
                },
            };
            outputs.push(txout);
        }
